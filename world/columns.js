...
function placeColumns() {
  ...
  var bound=Math.floor((Object.keys(globalTerrainData.xZones).length-2)/2)
  xCoord = globalTerrainData.xZones[0] + Math.random() * (globalTerrainData.xZones[bound] - globalTerrainData.xZones[0]);
